...
class TarMount(FuseOperations):  # type: ignore
    ...
    def __init__(self, pathToMount: Union[str, List[str]], mountPoint: str, **sqliteIndexedTarOptions) -> None:
        ...
        # This also will cread or load the block offsets for compressed formats
        ...
        # Close threads opened by the ParallelBZ2Reader for creating the block offsets
        # No threads should be created before FUSE forks, i.e., they should be created in 'init'
        # Threads will be automatically recreated again on the next read call.
